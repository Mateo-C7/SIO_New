                                ...
                                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(headersForRender), (header, index) => {
                                    return openBlock(), createElementBlock("th", {
                                        ...
                                        header.text === "checkbox" ? (openBlock(), createBlock(MultipleSelectCheckBox, {
                                            ...
                                            unref(slots)[`header-${header.value.toLowerCase()}`] ? renderSlot(_ctx.$slots, `header-${header.value.toLowerCase()}`, normalizeProps(mergeProps({ key: 0 }, header)), void 0, true) : (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(header.text), 1)),
...
if (typeof window !== "undefined" && window.Vue) {
    window.Vue.AppPQRS.component("EasyDataTable", DataTable);
}
