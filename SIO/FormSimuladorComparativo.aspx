<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="FormSimuladorComparativo.aspx.cs" Inherits="SIO.FormSimuladorComparativo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script type="module" src="Scripts/formSimuladorComparativo.js?v=20231004A"></script>
					...
					<table class="table table-sm table-bordered table-striped text-right" v-if="listComparativo.nivel1 != null">
						<thead>
							<tr>
								<th colspan="9" class="bg-info text-center">
									Comparativo de costos Simulador Vs Costos
								</th>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td class="td-divider"></td>
								<td>{{listComparativo.FechaCargue}}</td>
								<td class="td-divider"></td>
								<td></td>
								<td></td>
							</tr>
							...
							<tr>
								...
								<td>Ordenes</td>
								<td class="td-divider"></td>
								<td>{{listComparativo.nivel1.Orden}}</td>
								<td class="td-divider"></td>
								<td>{{listComparativo.nivel1.Ordenes_real}}</td>
								<td class="td-divider"></td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								...
								<td>Tasa TRM</td>
								<td class="td-divider"></td>
								<td>{{listComparativo.nivel1.tasaMonedaCotizacion.toLocaleString("en-US", {style:"currency", currency:"USD"})}}</td>
								<td class="td-divider"></td>
								<td>{{listComparativo.nivel1.tasaDolar.toLocaleString("en-US", {style:"currency", currency:"USD"})}}</td>
								<td class="td-divider"></td>
							...
							<tr>
								...
								<td class="td-divider"></td>
								<td>{{listComparativo.nivel1.M2_real.toLocaleString("en-US", {style:"currency", currency:"USD"})}}</td>
								<td class="td-divider"></td>
