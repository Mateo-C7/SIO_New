<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="VisAgendamiento.aspx.cs" Inherits="SIO.AgendamientoVis"
    Culture="es-CO" UICulture="es" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table>
                <tr>
                    <td>
                        <asp:Panel ID="Panel1" runat="server" CssClass="Letra" Font-Names="Arial" GroupingText="PLANEACION" Width="669px">
                            <table id="tblGeneral" runat="server" style="height: 246px; width: 670px" visible="false">
                                <tr>
                                    <td></td>
                                    <td class="TexIzq">
                                        <asp:CheckBox ID="chkRemoto" runat="server" Checked="false" Text="Reunión Remota?" />
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        <asp:CheckBox ID="chkForsa" runat="server" AutoPostBack="True" OnCheckedChanged="chkForsa_CheckedChanged" Text="SIO" TextAlign="Left" Checked="true"/>
                                        <asp:CheckBox ID="chkLite" runat="server" AutoPostBack="True" 
                                            OnCheckedChanged="chkLite_CheckedChanged" Text="SIM" TextAlign="Left" 
                                            Visible="false" />
                                    </td>
                                    <%-- <td class="TexIzq">
                                ...
                                <tr id="trCliLITE">
                                    <td class="TexDer">Empresa SIM : </td>
                                    <td>
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        <ContentTemplate>
            <table>
                <tr>
                    <td>
                        <asp:Panel ID="PanelGeneral" runat="server" Width="802px" CssClass="Letra">
                            <table>
                                <tr>
                                    <td style="width:230px"></td>
                                    <td>
                                        <asp:Label runat="server" ID="lblVisitaCreada" Font-Bold="true" Text="Visita Creada: " Visible="false"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblTitulo" Font-Bold="true" runat="server" Visible="false"></asp:Label>                                        
                                        <table>
                                            <tr id="trAgenda" runat="server">
                                                <td class="TexDer">Año :
                                                </td>
                                                <td class="TexIzq">
                                            ...
                                            <tr id="trZona" runat="server">
                                                <td class="TexDer">Zona :&nbsp;
                                                </td>
                                                <td colspan="3" class="TexIzq">
                                                    <asp:DropDownList ID="cboZonas" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboZonas_SelectedIndexChanged"
                                                        CssClass="ComboMG">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr id="trComercial" runat="server">
                                                <td class="TexDer">Comercial :&nbsp;
                                                </td>
                                                <td colspan="3" class="TexIzq">
                                                    <asp:DropDownList ID="cboComercial" runat="server" AutoPostBack="true" CssClass="ComboMG">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td style="width:400px">                                  
                                        <table id="guiaColor" runat="server"  align = "Center" >
                                            <tr align = "Center">                                                
            ...
            <table id="Table1" runat="server" class="styleDivDetViaj">
                </table>
        </ContentTemplate>
    </asp:UpdatePanel>
    <div id="dviLinea" runat="server" style="width: 675px; height: 6px; border-top: 1px solid black;">
    </div>
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:Panel ID="PanelCalendario" runat="server" Font-Names="Arial">
                <div id='wrap'>
                    <%--<div id='external-events' style="font-size: 7pt;">
                    </div>--%>
                    <div id='calendar'>                        
                    </div>
    ...
    <div id="PopupClientesLite" class="StPopupClientesLite" style="display: none;">
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                <asp:Panel ID="Panel2" runat="server" Font-Names="Arial" Height="252px" Width="635px"
                    CssClass="Letra">
                        ...
                        <tr>
                            <td>
                                <table style="width: 622px; height: 37px;">
                                    ...
                                    <tr>
                                         <td class="TexIzq">País :
                                        <asp:DropDownList ID="cboPais" runat="server" AutoPostBack="True" 
                                            CssClass="ComboM" OnSelectedIndexChanged="cboPais_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        </td>
                                        <td class="TexIzq">Ciudad :
                                        <asp:DropDownList ID="cboCiudad" runat="server" AutoPostBack="false" 
                                            CssClass="ComboM">
                                        </asp:DropDownList>
                                        </td>
                                        <td class="TexIzq">Periodo:
                                                    <asp:TextBox ID="txtPeriodo" runat="server" CssClass="TexboxP" ></asp:TextBox>
                                            <asp:CalendarExtender ID="txtPeriodoCE" runat="server" Format="MM/yyyy" TargetControlID="txtPeriodo">
                                            </asp:CalendarExtender>
                                            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender14" runat="server" FilterType="Custom, Numbers"
                                                ValidChars="/" TargetControlID="txtPeriodo">
                                            </asp:FilteredTextBoxExtender>
                                        </td>
                                    </tr>
                                </table>
