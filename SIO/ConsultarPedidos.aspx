<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true"
    CodeBehind="ConsultarPedidos.aspx.cs" Inherits="SIO.ConsultarPedidos" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="height: 15px; width: 367px;">
                <tr>
                    <td class="style42">
            ...
            <div style="height: 15px; width: 376px;">
            </div>
                            ...
                            <tr>
                                <td class="style11">
                                    <asp:GridView ID="grdEspecial" runat="server" BackColor="White" BorderColor="#999999"
                                        ...
                                        AutoGenerateColumns="False" Font-Size="7pt" Font-Names="Arial">
