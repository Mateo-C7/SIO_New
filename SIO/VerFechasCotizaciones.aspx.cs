...
namespace SIO
{
    public partial class VerFechasCotizaciones : System.Web.UI.Page
    {
        ...
        public void CargarReporteOrdenes()
        {
            ...
            Reporte.ServerReport.ReportServerCredentials = irsc;
            Reporte.ServerReport.ReportServerUrl = new Uri("http://10.75.131.2:81/ReportServer");
            Reporte.ServerReport.ReportPath = "/Comercial/COM_FechasCotizacionesCliente";

            Reporte.ShowToolBar = true;
        }
