<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="SeguimientoSim.aspx.cs" Inherits="SIO.SeguimientoSim" %>
...
<link rel="STYLESHEET" type="text/css" href="codebase/dhtmlxgrid.css">
    ...
    <script>
        ...
        function doOnLoad() {
            // init values
//            cmbZona = new dhtmlXCombo("a12b", "combo", 180);
//            cmbPais = new dhtmlXCombo("a12c", "combo2", 180);
//            cmbProb = new dhtmlXCombo("a12d", "combo3", 80);
//            cmbZonaCiu = new dhtmlXCombo("a12g", "combo4", 180);

            cmbZona = new dhtmlXCombo("zona", "combo", 180);
            cmbZona.loadXML("DatosFiltro.ashx");
            cmbZona.enableFilteringMode(false);

            cmbPais = new dhtmlXCombo("pais", "combo2", 180);
            cmbsubzona = new dhtmlXCombo("subzona", "combo", 180);
            ...
            cmbPais.attachEvent("onChange", function (value) {
                ...
                cmbsubzona.setComboValue(null);
                cmbsubzona.setComboText("");
                cmbsubzona.loadXML("DatosFiltro.ashx?Tipo=ZonaCiu&pai_Id=" + p);
            });
    ...
    <fieldset style="width: 600px">
        <table style="width: 180px">
            <tr>
                ...
                <td>
                 <asp:DropDownList ID="cbozona1" runat="server">
                        </asp:DropDownList>
                    <div id="zona"  name="a12b">
            ...
            <tr>
                ...
                <td>
                    &nbsp;<input type="button" name="a11" value="Filtrar" id="a11" onclick='
                        ...
                        background-color: #1C5AB6; font-weight: bold;"></td>
            </tr>
        </table>
        <br />
    </fieldset>
