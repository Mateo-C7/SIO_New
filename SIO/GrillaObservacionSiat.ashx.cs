...
namespace SIO
{
    ...
    public class GrillaObservacionSiat : dhtmlxRequestHandler
    {
        ...
        public override IdhtmlxConnector CreateConnector(HttpContext context)
        {
            ...
            dhtmlxGridConnector connector = new dhtmlxGridConnector(
                string.Format("EXECUTE USP_fup_SEL_ActSeg_ObservacionSiat " + idActa + ""),
                "asobs_id",
            ...
            if (idActa == "0" || idActa == "-1")
            {
                ...
                config.SetHeader("FUP,Tipo,Fecha, Observación,IdActa,Usuario");
            ...
            if (form["ids"] != null)
            {
                ...
                if (type == ActionType.Updated)
                {
                    connector.Request.CustomSQLs.Add(CustomSQLType.Update,
                        string.Format("EXECUTE USP_fup_UPD_ActSeg_Obs_Siat '{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}'",
