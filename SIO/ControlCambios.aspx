<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControlCambios.aspx.cs" Inherits="GrillaExample.ControlCambios" %>
...
<body onload="doOnLoad();>
    ...
    <div>
        ...
        <input type="hidden" id="Fup" name="Fup" runat="server" />
        <script>
        ...
        <div id="gridbox" style="width: 1200px; height: 300px; background-color: white;">
        </div>
        ...
        <div id="gridbox2" style="width: 1200px; height: 120px; background-color: white;">
        </div>
        ...
        <script>
            ...
            function LoadData() {
                var vFup = <%=Session["Fup"] %>;

                grTema.loadXML("GrillaControlCambioTema.ashx?Fup=" + vFup + "", function Combos() {
            ...
            function AddComentario() {
                ...
                var estado = grTema.cells(grTema.getSelectedId(), 7).getValue();                
                var today = new Date();
                if(estado == 'Cerrado')
                {
                    alert('El tema se encuentra cerrado. No puede ingresar mas comentarios');
                }
                else
                {
                    var vUser = '<%=Session["Nombre_Usuario"] %>';
                    var fila = today.yyyymmdd() + ',,'+vUser+',,' + grTema.getSelectedId();
            ...
            function AddTema() {
                ...
                var id = grTema.uid();
                var today = new Date();
                var fila = vFup + ',,' + today.yyyymmdd() + ',,'+vUser+',,,Abierto';
