    ...
    <fieldset style="border-style: none; border-width: 0px; width: 1153px">
        <table style="width: 1152px; height: 1px; margin-left: 0px;">
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <label id='a10x' style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt">MesEntrExw</label></td>
                <td class="auto-style8">
                    <input id="a12x" name="txtExw" type="text" style="font-family: Arial, Helvetica, sans-serif;
                        font-size: 8pt; width: 40px;"  />
                ...
                <td class="auto-style1">                
                    ...
                    tomarMesProdCom("a12fpc");
                        ...
                        if (document.getElementById("a13g1").value != ""){            
                            grActSeg.filterBy(15,document.getElementById("a13g1").value,true);
                        }                                            
    ...
    <table>
        <tr>
            <td class="auto-style17">
              <div id="gridbox3" style="width: 600px; height: 140px; background-color: white;">
                </div>  
            </td>         
...
//    }
        ...
        function AddObservacion() {
            ...
            var m2Total = grActSeg.cells(grActSeg.getSelectedId(), 10).getValue();
            var M2Pend = parseFloat( m2Total)- parseFloat(m2Planeados);
            var id = grActSeg3.uid();
            var today = new Date();
            var fila = grActSeg.cells(grActSeg.getSelectedId(), 3).getValue() + ',,,,'+Math.round(Number(parseFloat(M2Pend)) *100) / 100+ ', , ,' + grActSeg.getSelectedId();
          //var fila = grActSeg.cells(grActSeg.getSelectedId(), 3).getValue() + ',1,' + today.yyyymmdd() + ', ,' + grActSeg.getSelectedId();
            grActSeg3.addRow(id, fila, 0);
            grActSeg3.showRow(id);  
