...
{
    /// <summary>
    /// Summary description for GrillaObservacionDft
    /// </summary>
    public class GrillaObservacionDft : dhtmlxRequestHandler
    {
        ...
        public override IdhtmlxConnector CreateConnector(HttpContext context)
        {
            ...
            dhtmlxGridConnector connector = new dhtmlxGridConnector(
                string.Format("EXECUTE USP_fup_SEL_ActSeg_ObservacionDft " + idActa + ""),
                "asobs_id",
            ...
            if (form["ids"] != null)
            {
                ...
                if (type == ActionType.Updated)
                {
                    connector.Request.CustomSQLs.Add(CustomSQLType.Update,
                        string.Format("EXECUTE USP_fup_UPD_ActSeg_Obs_Dft '{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}'",
