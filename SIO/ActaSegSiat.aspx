<%@ Page Title="" Language="C#" MasterPageFile="~/GeneralAmplia.Master" AutoEventWireup="true" 
    CodeBehind="ActaSegSiat.aspx.cs" Inherits="SIO.ActaSegSiat" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function doOnLoad() {
            ...
            myCalendar = new dhtmlXCalendarObject(["txtFecIni","txtFecFin","a12f","a12x","a13g","a12fpc"]);
        ...
        function tomarEwx(id) {
    
            var mes = document.getElementById(id).value;
            mes = mes.substring(0,7);
            return document.getElementById("a12x1").value = mes;          
    ...
    <fieldset style="border-style: none; border-width: 0px; width: 1153px">
        <table style="height: 1px; margin-left: 0px;">
            <tr>
                <td class="auto-style12" >
                    <label id='a10a' style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt">Orden</label>
                </td>
                ...
                <td class="auto-style4">
                    <div id="a12c" name="a12c" class="auto-style39">
                    </div>
                </td>
                 <td class="auto-style4">
                     <label id='a10g' style="font-family: Arial, Helvetica, sans-serif; font-size: 8pt">MesPlanDesp</label>
                </td>
                <td class="auto-style5">
                    <input id="a13g" name="txtMesPlandesp" type="text" style="font-family: Arial, Helvetica, sans-serif;
                        font-size: 8pt; width: 40px;"  />
                        <input id="a13g1" name="txtMesPlandesp" type="hidden" style="font-family: Arial, Helvetica, sans-serif;
                ...
                <td class="auto-style43">
                    &nbsp;<input id="a12x1" name="txtExw" type="hidden" style="font-family: Arial, Helvetica, sans-serif;
                        font-size: 8pt; width: 48px;"  /></td> 
                <td class="auto-style9">
                    ...
                    tomarMes("a12f");
                    //tomarEwx("a12x");
                    tomarMesPlandesp("a13g");
                    //tomarMesProdCom("a12fpc");
                        grActSeg.filterBy(0,"");
                        if (document.getElementById("a12a").value != ""){
                          grActSeg.filterBy(9,document.getElementById("a12a").value,true);
                        }
                        ...
                        if (document.getElementById("a13g1").value != ""){            
                            grActSeg.filterBy(16,document.getElementById("a13g1").value,true);
                        } 
                        ...
                        grActSeg.filterBy(28,document.getElementById("a12f1").value,true);
                        }
                        //if (document.getElementById("a12x1").value != ""){            
                        //    grActSeg.filterBy(9,document.getElementById("a12x1").value,true);
                        //}
                        //if (document.getElementById("a12f1pc").value != ""){            
                        //    grActSeg.filterBy(14,document.getElementById("a12f1pc").value,true);
                        //}
                                                                   
                        if (cmbPlanta.getComboText() != ""){    
                            grActSeg.filterBy(44,cmbPlanta.getComboText(),true);
                        }      
                        if (cmbPlantaPlan.getComboText() != ""){    
                            grActSeg.filterBy(45,cmbPlantaPlan.getComboText(),true);
                        }                        
                        if (cmbEstadoPlan.getComboText() != ""){    
                            grActSeg.filterBy(53,cmbEstadoPlan.getComboText(),true);
                        }
                        calculateFooterValues();   '
                      
                        style="font-family: Arial, Helvetica, sans-serif;  font-size: 9pt; color: #FFFFFF;
                        background-color: #1C5AB6; width: 55px; height: 19px;"/></td>
                <td>
                    <div id="a12d" name="a12d" class="auto-style12" >
                    </div>
                </td> 
    ...
    <div id="gridbox" 
        style="width: 1290px; height: 360px; background-color: white;">
    </div>
    <table>
        <tr>
            <td>
        ...
        <tr>
            <td>
            <input type="button" name="add" id="Button1" runat="server" value="Adicionar Observacion"
    ...
    <table>
        <tr>
            <td class="auto-style17">
              <div id="gridbox3" style="width: 600px; height: 140px; background-color: white; visibility:hidden;">
                </div>  
            </td>         
            <td class="auto-style14" colspan="6">
                <div id="gridbox5"  style="width: 640px; height: 140px; background-color: white; visibility:hidden; ">
                </div> 
            </td>  
        ...
        <tr>
            ...
            <input type="button" name="add" id="add" runat="server" value="Asignar Semana" 
                    onclick="AddObservacion()" style="font-family: Arial, Helvetica, sans-serif;
                    font-size: 9pt; color: #FFFFFF; background-color: #1C5AB6; visibility:hidden;
                    width: 141px;"  />  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;                
                                 
             
            <input type="button" name="a91" visible="false" value="CalcularPendiente" id="a91" onclick='calculateFooterValuesProd();'
                      
                        style="font-family: Arial, Helvetica, sans-serif;  font-size: 8pt; color: #000000; visibility:hidden;
                        background-color: #FFFFFF; width: 100px;"/>
                </td>
            <td class="auto-style19">
                <input type="button" name="add1" id="add1" runat="server" value="Configurar Semana" visible="false"
                    onclick="AddObservacion1()" style="font-family: Arial, Helvetica, sans-serif; visibility:hidden;
                    font-size: 9pt; color: #FFFFFF; background-color: #1C5AB6; 
                    width: 141px;" />&nbsp;
                </td>
            ...
            <td >
               <label id='a10g' visible="false" style="font-family: Arial, Helvetica, sans-serif; visibility:hidden; font-size: 8pt">Año</label></td>
            ...
            <td class="auto-style25">
                 <label id='a10xg' visible="false" style="font-family: Arial, Helvetica,  sans-serif; visibility:hidden; font-size: 8pt">Mes</label></td>
            ...
            <td class="auto-style27">
                    <input type="button" name="a92" value="FiltrarMes" visible="false" id="a92" onclick='
                        ...
                        style="font-family: Arial, Helvetica, sans-serif;  font-size: 9pt; color: #FFFFFF;
                        background-color: #1C5AB6; visibility:hidden; width: 65px; height: 19px;"/></td>
    ...
    <table>
        <tr>
            <td class="auto-style31">
                <div id="gridboxn" style="width: 570px; height: 120px; background-color: white; display:none;">
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div id="gridbox4" style="width: 600px; height: 120px; background-color: white; visibility:hidden;">
                </div>                
            </td>
         </tr>
...
//    }
        ...
        grActSeg.attachEvent("onRowSelect", function (id) {
            ...
            grActSeg2.clearAll();
            grActSeg2.loadXML("GrillaObservacionSiat.ashx?IdActa=" + id + "&Rol=" + vRol);
        ...
        var dp = new dataProcessor("GrillaContenidoSiat.ashx?Rol=" + vRol + "&Usu=" + vUsu);
        dp.init(grActSeg);
        ...
        grActSeg2.loadXML("GrillaObservacionSiat.ashx?IdActa=-1&Rol=" + vRol + "&Usu=" + vUsu);

        var dp2 = new dataProcessor("GrillaObservacionSiat.ashx?IdActa=-2&Rol=" + vRol + "&Usu=" + vUsu);
        dp2.init(grActSeg2);
        ...
        function LoadData(fDesde, fHasta, trm, perd) {
            ...
            grActSeg.loadXML("GrillaContenidoSiat.ashx?fecDesde=" + fDesde + "&fecHasta=" + fHasta+ "&Rol=" + vRol + 
                ...
                cmbTipoObservacion.loadXML("DatosFiltro.ashx?Tipo=TipoObsSiat");
                ...
                cmbMesPlanProd = grActSeg3.getColumnCombo(2);
                cmbMesPlanProd.loadXML("DatosFiltro.ashx?Tipo=MesPlanProd");

                cmbSemPlanProd = grActSeg3.getColumnCombo(3);
                cmbSemPlanProd.loadXML("DatosFiltro.ashx?Tipo=SemPlanProd");                
				...
				grActSeg3.attachFooter("M2 Pendientes,#cspan,#cspan,#cspan,<div id='nr_m' class='divcolor' ;>0</div>",["text-align:rigth; font-size:10pt; color:black;"]);
                //grActSeg5.clearAll()
                //grActSeg5.loadXML("GrillaProdSemana.ashx?Usu=" + vUsu+ "&Rol=" + vRol);
        ...
        //Suma todos los valores de m2 planprod
        function sumColumnM2PlanProd(ind){
            var out = 0;
            for(var i=0;i<grActSeg3.getRowsNum();i++){
                out+=parseFloat(grActSeg3.cells2(i,ind).getValue());
            }          
            //parsea el resultado a un digito decimal
            result=out.toLocaleString("en-US", { maximumFractionDigits: 2, minimumFractionDigits: 2 });
        ...
        function AddObservacion() {
            ...
            var today = new Date();
            var fila = grActSeg.cells(grActSeg.getSelectedId(), 4).getValue() + ',14,' + today.yyyymmdd() + ', ,' + grActSeg.getSelectedId();
