<%@ Page Title="" Language="C#" MasterPageFile="~/ReporteEmpleado.Master" AutoEventWireup="true" CodeBehind="ActualizacionDatosEmpleado1.aspx.cs" Inherits="SIO.ActualizacionDatosEmpleado" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table>
                    ...
                    <tr>
                        ...
                        <td class="auto-style15">
                            <asp:DropDownList ID="Txt_CargoActual1" runat="server"  AutoPostBack="false" Width="225px" CssClass="auto-style3" OnSelectedIndexChanged="Txt_CargoActual1_SelectedIndexChanged" ></asp:DropDownList>
                        </td>               
                        <td style="text-align: right" class="auto-style18" >  
                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;                       
                              ...
                              <asp:GridView ID="GridConvivePers" runat="server" BackColor="White" BorderColor="#999999"
                                  ...
                                  <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="Edad"  HeaderStyle-Width="40px">
                                          <EditItemTemplate>
                                              <asp:TextBox ID="txtEdad" Width="40px" MaxLength="4" runat="server" Text='<%# Bind("covemp_Edad") %>'></asp:TextBox>
                                          </EditItemTemplate>
                                          <ItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="Nivel Educativo" HeaderStyle-Width="110px">
                                          <EditItemTemplate>
                                              <asp:DropDownList ID="cboNivelEduca" runat="server" Width="110px" Text='<%# Bind("covemp_Nivel_Educativo") %>'>
                                     <asp:ListItem>ELEGIR UNA OPCION</asp:ListItem>
                                  <asp:ListItem>BASICA PRIMARIA</asp:ListItem>
                                  <asp:ListItem>BACHILLERATO</asp:ListItem>
                                  <asp:ListItem>TÉCNICO</asp:ListItem>
                ...
                Width="100%" Height="100%" CssClass="auto-style2">
                  ...
                  <table>
                          ...
                          <td>
                              <asp:GridView ID="GridNoConvivePers" runat="server" BackColor="White" BorderColor="#999999"
                                  ...
                                  <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="Edad"  HeaderStyle-Width="40px"> 
                                          <EditItemTemplate>
                                              <asp:TextBox ID="txtEdadNoConvi" Width="40PX" MaxLength="4" runat="server" Text='<%# Bind("hjnocov_Edad") %>'></asp:TextBox>
                                          </EditItemTemplate>
                                          <ItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="Nivel Educativo"  HeaderStyle-Width="110px">
                                          <EditItemTemplate>
                                              <asp:DropDownList ID="cboNIvelEducaNoConvi" Width="150px" runat="server" Text='<%# Bind("hjnocov_Nivel_Educativo") %>'>
                             <asp:ListItem>ELEGIR UNA OPCION</asp:ListItem>
                                  <asp:ListItem>BASICA PRIMARIA</asp:ListItem>
                                  <asp:ListItem>BACHILLERATO</asp:ListItem>
                                  <asp:ListItem>TÉCNICO</asp:ListItem>
                    ...
                    <br />
                      ...
                      Font-Names="Arial" Font-Size="8pt" ForeColor="Black" 
                      GroupingText="EN CASO DE EMERGENCIA AVISAR A" Width="100%" Height="100%" CssClass="auto-style2">
                      <table>
                          <tr>
                              <td style="text-align: right">
               ...
               Font-Names="Arial" Font-Size="8pt" ForeColor="Black" GroupingText="¿QUE ESTUDIOS TIENE?"
                Width="1140px" Height="100%" CssClass="auto-style2">
                           <table>
                               <tr>
                                   <td style="text-align: right">
                                       <asp:Label ID="lbltitulo_Estudios" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Titulo:" Width="30px"></asp:Label>
                                   </td>
                                   <td style="text-align: left" class="altoRengInicio">
                                       <asp:TextBox ID="txt_Titulo" MaxLength="50" AutoPostBack="false" runat="server" Width="196px" ToolTip="Titulo obtenido"></asp:TextBox>
                                   </td>
                                   <td style="text-align: right">
                                       <asp:Label ID="lblprograma_Estudios" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Programa:" Width="50px"></asp:Label>
                                   </td>
                                   <td style="text-align: left" class="altoRengInicio">
                                       <asp:TextBox ID="txt_Programa" MaxLength="50" AutoPostBack="false" runat="server" Width="196px"></asp:TextBox>
                                   </td>
                                    <td style="text-align: right">
                                   ...
                                   <td style="text-align: left" class="altoRengInicio">
                                       <asp:DropDownList ID="cbo_Cursando" runat="server" AutoPostBack="true" OnTextChanged="cbo_Cursando_TextChanged">
                               ...
                               <tr>
                                   ...
                                   <td style="text-align: left" class="altoRengInicio">
                                       <asp:TextBox ID="txt_FechaInicio" MaxLength="10" AutoPostBack="false" runat="server" Width="90px"></asp:TextBox>
                               ...
                               <tr>
                                       <td style="text-align: right">
                                       <asp:Label ID="lblañogradu_Estudios" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Año Graduacion:" Width="90px"></asp:Label>
                                   </td>
                                   <td style="text-align: left" class="altoRengInicio">
                                   ...
                                   <td style="text-align: left" class="altoRengInicio">
                                        <asp:DropDownList ID="cbo_Estu_Externo" runat="server" AutoPostBack="false" ToolTip="Estudio realizado por fuera de  la empresa">
                                          ...
                                          <td style="text-align: right">
                                       <asp:Label ID="lblcostea_Estudios" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Estudio Costeado:" Width="90px"></asp:Label>
                                   </td>
                                   <td style="text-align: left" class="altoRengInicio">
                ...
                AutoGenerateColumns="False" Font-Size="8pt" Font-Names="arial" Height="16px" PageSize="10" 
                ...
                OnRowUpdating="GridEstudios_RowUpdating" OnRowDeleting="GridEstudios_RowDeleting" OnPageIndexChanging="GridEstudios_PageIndexChanging" ShowHeaderWhenEmpty="True">
                              <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Titulo" HeaderStyle-Width="210px">
                                      <EditItemTemplate>
                                          <asp:TextBox ID="txt_Titulo" Width="210px" runat="server" Text='<%# Bind("est_tipo") %>'></asp:TextBox>
                                      </EditItemTemplate>
                                      <ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="Programa" HeaderStyle-Width="210px">
                                      <EditItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="Año Graduacion" HeaderStyle-Width="100px" >                              
                                      <EditItemTemplate>
                ...
                <SortedDescendingHeaderStyle BackColor="#000065" />
                  ...
                  <asp:Panel runat="server" ID="pnlVehiculo"
                       Font-Names="Arial" Font-Size="8pt" ForeColor="Black" 
                Width="529px" Height="100%" CssClass="auto-style2">
                      <table class="auto-style23">
                          <tr>
                            ...
                            <asp:CheckBox ID="chkNoPlacaCarro" Text="No" runat="server" AutoPostBack="true" OnCheckedChanged="chkNoPlacaCarro_CheckedChanged" />
                                  &nbsp&nbsp&nbsp&nbsp&nbsp
                            <asp:Label runat="server" Font-Names="Arial" Font-Size="8pt" Text="Placa1" Width="30px"></asp:Label>
                              </td>
                           ...
                           <td class="auto-style30">
                                <asp:Label runat="server" Font-Names="Arial" Font-Size="8pt" Text="Placa2" Width="30px"></asp:Label>                                  
                           </td>
                               <td class="auto-style9" >
                          ...
                          <tr>
                              ...
                              <td class="auto-style31">
                                  <asp:CheckBox ID="chkSiPlacaMoto" Text="Si" runat="server" AutoPostBack="true" OnCheckedChanged="chkSiPlacaMoto_CheckedChanged" />
                                  &nbsp&nbsp&nbsp&nbsp&nbsp
                            <asp:CheckBox ID="chkNoPlacaMoto" Text="No" runat="server" AutoPostBack="true" OnCheckedChanged="chkNoPlacaMoto_CheckedChanged" />
                                  &nbsp&nbsp&nbsp&nbsp&nbsp
                            <asp:Label runat="server" Font-Names="Arial" Font-Size="8pt" Text="Placa1" Width="30px"></asp:Label>
                              </td>
                              <td class="auto-style32">
                                  <asp:TextBox ID="txtPlacaMoto" runat="server" MaxLength="6" Width="70px" AutoPostBack="false" OnTextChanged="txtPlacaMoto_TextChanged"></asp:TextBox>
                              </td>
                                <td class="auto-style30">
                                <asp:Label runat="server" Font-Names="Arial" Font-Size="8pt" Text="Placa2" Width="30px"></asp:Label>                                  
                           </td>
                                <td class="auto-style26">
                                  <asp:TextBox ID="txtPlacaMoto2" runat="server" MaxLength="6" Width="70px" AutoPostBack="false" OnTextChanged="txtPlacaMoto2_TextChanged"></asp:TextBox>
                              </td>
                              <td class="auto-style25">
